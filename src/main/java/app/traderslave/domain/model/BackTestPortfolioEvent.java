...
public class BackTestPortfolioEvent extends BasePersistentModel {
    ...
    public enum EventType {
        ...
        public static EventType retrieveByOrderStatus(BackTestOrder.Status status) {
            EventType eventType = null;
            if(status == BackTestOrder.Status.OPEN) {
